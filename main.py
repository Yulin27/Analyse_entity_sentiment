...
def console_args():
    ...
    parser.add_argument("--root_path", type=str, default="nlp_data", help="root path")
    parser.add_argument("--train_data_path", type=str, default="nlp_data/train.txt", help="train data path")
    parser.add_argument("--pseudo_data_path", type=str, help="pseudo data path", required=False)
    parser.add_argument("--test_data_path", type=str, default="nlp_data/test.txt", help="test data path")
